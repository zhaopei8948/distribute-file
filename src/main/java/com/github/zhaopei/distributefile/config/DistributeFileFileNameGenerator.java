 ...
 */
public class DistributeFileFileNameGenerator implements org.springframework.integration.file.FileNameGenerator {
    ...
    public DistributeFileFileNameGenerator(String prefix, String suffix, Boolean headerId) {
        this.prefix = prefix;
        this.suffix = suffix;
        this.headerId = headerId;
    }

    public DistributeFileFileNameGenerator() {
